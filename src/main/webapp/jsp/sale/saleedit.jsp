...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>编辑销售机会 <i class="fa fa-user"></i><small>${devUserSession.devName}</small></h2>
             <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="/doSaleEdit" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="chcCustName" class="form-control col-md-7 col-xs-12" name="chcCustName"
                     ...
                     placeholder="请输入客户名称" type="text" value="${sal.chcCustName}">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="chcRate" class="form-control col-md-7 col-xs-12"
                     ...
                     placeholder="请输入成功几率" type="text" value="${sal.chcRate}">
            </div>
          </div>
          <div class="item form-group">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="chcDueDate" name="chcDueDate" type="text" value="<fmt:formatDate value="${sal.chcDueDate}" pattern="yyyy-MM-dd"></fmt:formatDate>" class="form-control col-md-7 col-xs-12"/>
            </div>
          </div>
