...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					历史订单 <i class="fa fa-user"></i><small>
						- 您可以通过客户编号、客户名称查看历史订单信息。^_^</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
					...
					<li>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input name="querySoftwareName" readonly="readonly" type="text" class="form-control col-md-7 col-xs-12" value="${map.softwareName }">
							</div>
						</div>
					</li>
					<li>
