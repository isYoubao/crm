	  ...
	  <!-- <div class="item form-group">
        ...
        <form class="form-horizontal form-label-left" action="doAppInfoAdd" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="s" class="form-control col-md-7 col-xs-12"
                     data-validate-length-range="20" data-validate-words="1" name="softwareName"
                     type="text" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="ss" class="form-control col-md-7 col-xs-12"
                     data-validate-length-range="20" data-validate-words="1" name="softwareName"
                     type="text" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="sff" class="form-control col-md-7 col-xs-12"
                     data-validate-length-range="20" data-validate-words="1" name="softwareName"
                     type="text" readonly="readonly">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="fff" class="form-control col-md-7 col-xs-12"
                     data-validate-length-range="20" data-validate-words="1" name="softwareName"
                     type="text" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="ffff" class="form-control col-md-7 col-xs-12"
                     data-validate-length-range="20" data-validate-words="1" name="softwareName"
                     type="text" readonly="readonly">
            </div>
          </div>
