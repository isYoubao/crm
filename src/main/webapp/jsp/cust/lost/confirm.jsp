...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2> 确认流失 <i class="fa fa-user"></i><small>${devUserSession.devName}</small></h2>
             <div class="clearfix"></div>
      </div>
      <div class="x_content">
        ...
        <form class="form-horizontal form-label-left" action="doAppInfoAdd" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
              ...
              <button type="button" class="btn btn-primary" id="queren">暂缓流失</button>
