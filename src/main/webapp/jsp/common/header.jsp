...
<title>滨华科技客户关系管理系统</title>
	...
	<link href='${pageContext.request.contextPath }/localcss/appinfoadd.css' rel='stylesheet'>
	<link href='${pageContext.request.contextPath }/localcss/appinfolist.css' rel='stylesheet'>
</head>
			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/main" class="site_title"><i class="fa fa-paw"></i> <span>BinHua
								CRM</span>
						</a>
					</div>
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							<h3>${sysUser.usrName }</h3>
							<ul class="nav side-menu">
								<c:forEach items="${sysUser.sysRole.sysRights}" var="rights">
									<c:if test="${rights.rightType=='Folder'}">
										<li><a><i class="fa fa-edit"></i>${rights.rightText}<span
												class="fa fa-chevron-down"></span></a>
											<ul class="nav child_menu">
												<c:forEach items="${sysUser.sysRole.sysRights}" var="rig">
													<c:if test="${rig.rightParentCode==rights.rightCode}">
														<li><a href="${rig.rightUrl}">${rig.rightText}</a>
														</li>
													</c:if>
												</c:forEach>
											</ul>
