    ...
    <div class="x_panel">
              ...
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
                ...
                <form class="form-horizontal form-label-left" >
                  <tr role="row" class="odd">
                    ...
                    <td><input type="text" name="zhixingxiaoguo"/>    <input type="submit" value="保存"/></td>
                  </tr>
                </form>
                </tbody>
              </table>
      ...
      <div class="form-group">
        <div class="col-md-6 col-md-offset-3">
          <button id="zzkc" type="button" class="btn btn-success">终止开发</button>
          <button id="zdjh" type="button" class="btn btn-success">制定计划</button>
          <button id="kccg" type="button" class="btn btn-success">开发成功</button>
